...
% title included in schlussbericht/backend_architecture
\include{schlussbericht/backend_architecture}
\include{schlussbericht/frontend_architecture}
\include{schlussbericht/interaktionsdiagramme}

% title included in schlussbericht/sourcecode
...
\end{longtabu}
\include{schlussbericht/projektmanagement}

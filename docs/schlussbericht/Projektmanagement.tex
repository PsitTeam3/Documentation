...
\begin{longtabu} to \textwidth { | X[l] | l | l | l | l | l | l | l | l | l | }
\hline
\textbf{Person} & \textbf{Infrastruktur} & \textbf{Dokumentation} & \textbf{Analyse/Design} &\textbf{Frontend} &\textbf{Backend} &\textbf{Testing} & \textbf{Administratives} & \textbf{Meetings}& \textbf{Präsentationen} & \textbf{Total} \\\hline
\endhead

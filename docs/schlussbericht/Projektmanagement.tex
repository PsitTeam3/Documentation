...
Für die Entwicklung halten wir uns an den Unified Process und Arbeiten Architektur Zentriert (siehe \fullref{design}). Das Projekt teilen wir in einwöchige Iterationen ein. Die genaue Einteilung der Iterationen finden Sie unter: \fullref{detaillierter-projektplan}.
Ebenfalls wird das gesamte Projekt gemäss Unified Process in 4 Phasen unterteilt, die Inception, Elaboration, Construction und Transistion Phase*, genaueres finden Sie unter \fullref{detaillierter-projektplan}.
...
Die Abweichung zwischen dem Stunden Total der Arbeitspakete und dem Stunden Total der Kategorien kommt daher, dass nicht alle administratien Aufwände Paketiert wurden um eine gewisse flexibilität zu ermöglichen.

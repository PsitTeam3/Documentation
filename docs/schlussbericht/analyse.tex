...
der identifizierten Objekte und Tätigkeiten der Touristen.
...
Route, also einer Teilstrecke der Tour. Die App zeigt dem Touristen seine
...
zeigt dem Touristen seine aktuelle Position mit einem Marker (z.B. Punkt)
...
kann die Position des Touristen nicht per GPS abfragen, in der Nähe stehen
...
An einem Zielpunkt / Besichtigungspunkt angelangt, wird die Touristin aufgefordert, ein Foto
von einem vorgegebenen Objekt zu erstellen. Die
...
Nach dem korrekten validieren der Position des Touristen, zeigt ihm die App
den nächsten Besichtigungspunkt mit einem Marker auf einer
...
\begin{figure}
  \centering
  \includegraphics[height=12cm]{Anwendungsfalldiagramm2}

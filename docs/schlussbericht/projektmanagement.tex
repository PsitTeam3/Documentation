...
(siehe \fullref{design}). Das Projekt teilen wir in zweiwöchige Iterationen ein. Die genaue
Einteilung der Iterationen finden Sie unter: \fullref{detaillierter-projektplan}.
Ebenfalls wird das gesamte Projekt gemäss Unified Process in 4 Phasen unterteilt, die Inception,
Elaboration, Construction und Transition Phase, Genaueres finden Sie unter \fullref{detaillierter-projektplan}.

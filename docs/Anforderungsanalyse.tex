...
Total Phase: & 13 & & 65,0 h & 40,0 h\\\hline
...
Total Phase: & 14 & & 45,0 h & 38,25 h\\\hline
\multicolumn{5}{| l |}{ }\\\hline
...
\endhead
 ...
 & Erben, Saurer, Schneidinger             & 1       & C-02 & UC 1 Liste der verfügbaren Touren \\\hline
 & Bof, Loth                               & 1       & C-03 & UC 1 Starten einer Tour \\\hline
...
\subsection{Nächste Iteration}\label{nächste_iteration}
...
\textbf{Client (App):} Es wird eine Liste von Touren angezeigt. Wenn eine Tour ausgewählt wird, dann sieht der User seine Position auf der Karte. Es wird die Route zu einem Punkt angezeigt. 
Da die mobile App-Entwicklung die grösste Ungewissheit birgt, arbeiten darauf drei Leute: Andi, Raffaele und Josef.
Die Schäztungen der Arbeitspakete sind in der \textbf{Tabelle unter 2.2} ersichtlich. Diese basieren auf Experimenten oder Erfahrung mit der Technologie. Hierbei handelt es

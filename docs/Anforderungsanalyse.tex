...
Web Service & \specialcell{.NET Framework 4.5\\C\# 5.0\\ASP.NET Web-API 2.2 (5.2.3)\\Entity Framework 6.0\\Ninject Dependency Injection Framework 3.2\\Microsoft SQL Server}\\\hline
...
\subsubsection{Kartenfunktionalität}\label{kartenfunkt}
Zur Verfikation das ein Tourist einen Punkt der Tour besichtigt hat, werden die GPS-Koordinaten des aufgenommenen Photos verwendet. Dabei muss eine gewisse Abweichungstoleranz zur Soll-Koordinate berücksichtigt werden. Wie hoch diese Toleranz sein soll, muss noch genauer evaluiert werden.
...
Um Touren durchführen zu können, muss sich die Touristin authentifizieren.
Dazu kann der Tourist ein Konto anlegen, oder sich mit seinem Facebook-
...
Die Tourensuche funktioniert nur, wenn der Tourist Internetzugang hat.
...
Für die Umsetzung des Backends sollen folgende Entwicklungsumgebung verwendet werden:
...
Als Entwicklungsumgebung für die Android App gilt folgendes:
